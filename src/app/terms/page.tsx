    ...
    <>
      ...
      <Section spacing="afterHeader" width="prose">
        <Prose>
          <h2>Who we are</h2>
          <p>
            Add the registered company name, company number, registered office
            and VAT number for {siteConfig.legalName}. Consumers are entitled to
            this information before they buy.
          </p>
          ...
          <p>
            ...
            they receive. Confirm the wording with whoever handles food
          ...
          <p>
            ...
            caused by negligence, fraud, or anything else that cannot lawfully
            be excluded.
          </p>
