...
export const categories: ProductCategory[] = [
  {
    ...
    image: {
      url: "/images/products/chicken-chilli-sauce-hot-250g.jpg",
  ...
  },
  {
    ...
    image: {
      url: "/images/products/all-purpose-seasoning-mix.jpg",
...
export const products: Product[] = [
  {
    ...
    image: {
      url: "/images/products/beans-chilli-sauce-mild.jpg",
  ...
  },
  {
    ...
    heat: "mild",
    image: {
      url: "/images/products/beef-chilli-sauce-mild.jpg",
  ...
  },
  {
    ...
    image: {
      url: "/images/products/beef-chilli-sauce-hot-250g.jpg",
    ...
    images: [
      {
        url: "/images/products/beef-chilli-sauce-hot.jpg",
  ...
  },
  {
    ...
    images: [
      {
        url: "/images/products/chicken-chilli-sauce-hot.jpg",
        alt: "Square jar of Efamy chicken chilli sauce, hot",
        width: 1136,
        height: 1400,
      },
      {
        url: "/images/lifestyle/chicken-chilli-sauce-hot-kitchen.jpg",
        alt: "Efamy chicken chilli sauce on a board with fresh chillies, garlic and ginger",
        width: 1414,
        height: 1140,
      },
    ],
  ...
  },
  {
    ...
    allergens: ["Fish"],
    image: {
      url: "/images/products/fish-chilli-sauce-mild.jpg",
  ...
  },
  {
    ...
    allergens: ["Fish"],
    image: {
      url: "/images/products/fish-chilli-sauce-hot.jpg",
    ...
    images: [
      {
        url: "/images/products/fish-chilli-sauce-hot-large.jpg",
  ...
  },
  {
    ...
    dietary: ["No artificial preservatives"],
    image: {
      url: "/images/products/pork-chilli-sauce-hot.jpg",
  ...
  },
  {
    ...
    images: [
      {
        url: "/images/products/all-purpose-seasoning-sample-pouch.jpg",
  ...
  },
  {
    ...
    size: "",
    image: {
      url: "/images/products/kelewele-seasoning-mix.jpg",
  ...
  },
  {
    ...
    dietary: ["No artificial preservatives"],
    image: {
      url: "/images/products/coat-and-cook.jpg",
